...
Compile command: g++ Matching_engine_testing.cpp LOB.cpp Matching_engine.cpp -o match_test.exe
Run command: ./match_test.exe
...
for multiple things trading, pass by reference to matching_engine using a switch to decide which LOB to pass
